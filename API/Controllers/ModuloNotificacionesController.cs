...
public class ModuloNotificacionesController : BaseController
{
    ...
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<ModuloNotificaciones>> Post(ModuloNotificacionDto modulonotificacionDto)
    {
        var modulonotificacion = _mapper.Map<ModuloNotificaciones>(modulonotificacionDto);
        ...
        modulonotificacionDto.Id = (int)modulonotificacion.Id;
    ...
    public async Task<ActionResult<ModuloNotificacionDto>> Put(int id, [FromBody] ModuloNotificacionDto modulonotificacionDto)
    {
        ...
        var modulosnotificaciones = _mapper.Map<ModuloNotificaciones>(modulonotificacionDto);
